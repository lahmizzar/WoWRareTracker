...
L["navi_naviaddon_name"] = "inGame navigation with: (inaktive)"
L["navi_naviaddon_desc"] = "Select which Navi to use. Please Note: TomTom could save a list of waypoints while Zygor only show the last you've clicked"
L["navi_naviaddon_zygor"] = "Zygor"
L["navi_naviaddon_tomtom"] = "TomTom"
L["warfront"] = "Warfront"
L["warfront_controll_by_name"] = "Who controll the Warfront?"
L["warfront_controll_by_desc"] = "Select the faction wo has control over Arathi Highlands. (Tip: The faction wo has control over Arathi Highlands has a portal to Arathi in Boralus/Dazar'alor to Arathi Highlands"
L["warfront_controll_by_horde"] = "Horde"
L["warfront_controll_by_alliance"] = "Alliance"
L["warfront_controll_changed_reloadui"] = "Please reload your UI in order to use the new settings!"
...
L["wrt_description_arathi_faction_control"] = "Version |cFFffaa00%s|r - Work in progress: Change waypoints for some Rares if other faction controls Arathi"
