...
L["show_menu_name"] = "Rare Menü am Mimimap Button"
L["show_menu_desc"] = "Art und weise, wie das Rare Menü angezeigt werden soll."
L["on_mouseover"] = "mit Mauszeiger zeigen"
L["on_leftClick"] = "mit linker Maustaste klicken"
...
L["navi_naviaddon_name"] = "inGame Navigation mit: (Inaktiv)"
L["navi_naviaddon_desc"] = "Wähle ein Navi-Addon das benutzt werden soll. Bitte beachte, dass TomTom mehrere Wegpunkte speichern kann, während Zygor nur den letzten anzeigt (basierend auf dem Rare auf den geklickt wurde)"
L["navi_naviaddon_zygor"] = "Zygor"
L["navi_naviaddon_tomtom"] = "TomTom"
L["warfront"] = "Kriegsfront"
L["warfront_controll_by_name"] = "Wer kontrolliert die Kriegsfront?"
L["warfront_controll_by_desc"] = "Wähle die Fraktion aus, die derzeit die Kontrolle über das Arathibecken hat. (Tip: Die Fraktion mit der Kontrolle, hat ein Portal in Boralus/Dazar'alor zum Arathihochland)"
L["warfront_controll_by_horde"] = "Horde"
L["warfront_controll_by_alliance"] = "Allianz"
L["warfront_controll_changed_reloadui"] = "Bitte das UI neu laden, damit die neuen Einstellungen wirksam werden!"
...
L["wrt_description_arathi_faction_control"] = "Version |cFFffaa00%s|r - In Arbeit: Wegpunktwechsel einzelner Rares, wenn die andere Fraktion Arathi kontrolliert"
